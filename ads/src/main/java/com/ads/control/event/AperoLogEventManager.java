...
public class AperoLogEventManager {
    ...
    private static final String TAG = "GambiLogEventManager";
    ...
    private static void logEventWithAds(Context context, float revenue, int precision, String adUnitId, String network, int mediationProvider) {
        ...
        Log.d(TAG,"adUnitId : " + adUnitId + "_____network: " + network + "____revenue : " + revenue);
        ...
        // log revenue this adf
//        logPaidAdImpressionValue(context, revenue, precision, adUnitId, network, mediationProvider);

        logPaidAdImpressionValue(context, revenue / 10000.0, precision, adUnitId, network, mediationProvider);
...
//        value = value / 10000.0;
        ...
        Log.d(TAG,"logPaidAdImpressionValue 2 adUnitId : " + adunitid + "_____network: " + network + "____revenue : " + value);
    ...
    public static void logTotalRevenue001Ad(Context context) {
        ...
        if (revenue / 1000000 >= 0.01) {
            ...
            Bundle bundle = new Bundle();
            bundle.putFloat("value", revenue / 10000);
